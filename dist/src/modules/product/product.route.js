...
productRoutes.get("/category/:categoryname", productController.getProductsByCategory);
productRoutes.get("/forseller/:id", productController.getProductDetailsForSeller);
productRoutes.get("/:id", productController.getProductById);
productRoutes.post("/create", auth("seller"), 
//   validateRequest(sellerValidation.storeCreateSchema),
productController.createProduct);
productRoutes.post("/addtocart/:id", auth("customer"), 
//   validateRequest(sellerValidation.storeCreateSchema),
productController.addProductToCart);
productRoutes.post("/cart/increase/:id", auth("customer"), productController.increaseCart);
productRoutes.post("/cart/decrease/:id", auth("customer"), productController.decreaseCart);
productRoutes.get("/store/:id", 
//   validateRequest(sellerValidation.storeCreateSchema),
productController.getProductsByStoreId);
productRoutes.delete("/:id", auth("seller"), 
//   validateRequest(sellerValidation.storeCreateSchema),
productController.deleteProductById);
productRoutes.patch("/:id", auth("seller"), 
//   validateRequest(sellerValidation.storeCreateSchema),
